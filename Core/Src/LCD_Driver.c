...
void LCD_Draw_Square(uint16_t Xpos, uint16_t Ypos, uint16_t len, uint16_t color) {
    LCD_Draw_Vertical_Line(Xpos+len, Ypos, len, color);
    LCD_Draw_Vertical_Line(Xpos, Ypos, len, color);
    LCD_Draw_Horizontal_Line(Xpos, Ypos, len, color);
    LCD_Draw_Horizontal_Line(Xpos, Ypos+len, len, color);
}
...
void LCD_Draw_Triangle(uint16_t Xpos, uint16_t Ypos, uint16_t heightlen, uint16_t baselen, uint16_t color){
    LCD_Draw_Vertical_Line(Xpos, Ypos, heightlen, color);
    LCD_Draw_Vertical_Line(Xpos+baselen, Ypos, heightlen, color);
    LCD_Draw_Horizontal_Line(Xpos, Ypos, baselen, color);
    LCD_Draw_Horizontal_Line(Xpos, Ypos+heightlen, baselen, color);
}
...
void titlescreen(){ // TODO make a real title screen, and level instructions functions
    ...
    LCD_DisplayChar(100, 70, 'H');
    LCD_DisplayChar(115, 70, 'I');
    LCD_DisplayChar(130, 70, '!');

    LCD_DisplayChar(90, 120, 'T');
    LCD_DisplayChar(100, 120, 'E');
    LCD_DisplayChar(110, 120, 'T');
    LCD_DisplayChar(120, 120, 'R');
    LCD_DisplayChar(130, 120, 'I');
...
void QuickDemo(void)
{
    ...
    LCD_DisplayChar(40,140,'H');
    LCD_DisplayChar(55,140,'e');
    LCD_DisplayChar(65,140,'l');
    LCD_DisplayChar(70,140,'l');
    LCD_DisplayChar(80,140,'o');

    LCD_DisplayChar(40,160,'W');
    LCD_DisplayChar(55,160,'o');
    LCD_DisplayChar(65,160,'r');
    LCD_DisplayChar(70,160,'l');
    LCD_DisplayChar(80,160,'d');
